...
public class GameManager : SingletonMonoBehavior<GameManager>
{
    ...
    private IEnumerator GameWon()
    {
        ...
        int rank = HighScoreManager.Instance.GetRank(playerScore);
        ...
        if (rank > 0 && rank <= Settings.numberOfHighScoresToSave)
        {
            ...
            HighScoreManager.Instance.AddScore(new Score() { playerName = name, levelDescription = "LEVEL " + 
                ...
                playerScore = playerScore }, rank);
        }
        else
        {
            rankText = "YOUR SCORE ISN'T RANKED, BETTER LUCK NEXT TIME ";
        }
    ...
    private IEnumerator GameLost()
    {
        ...
        yield return StartCoroutine(DisplayMessageRoutine("YOUR DEBT IS STILL OUTSTANDING "
            + GameResources.Instance.currentPlayer.playerName + "!", Color.white, 5f));
